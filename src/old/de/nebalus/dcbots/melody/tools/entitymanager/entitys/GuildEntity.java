...
import old.de.nebalus.dcbots.melody.tools.entitymanager.DatabaseValueContainer;
import old.de.nebalus.dcbots.melody.tools.entitymanager.Entity;
...
public final class GuildEntity extends Entity {
	...
	public boolean export() {
		if (database.isConnected()) {
			...
			String rawoptions = "";
			final List<GuildEntityDBOptions> exportoptions = new ArrayList<>();
