...
public enum FileResource {
	CONFIG("/", "config.yml"), DATABASE("/", "database.db"),

	IMG_COLORLINE("/img/", "colorline.png"), IMG_TRACKINFO("/img/", "trackinfo.png"),
	IMG_DEFAULTAVATAR("/img/", "default-avatar.png"),

	LANG_GERMAN("/lang/", "german.json"), LANG_ENGLISH("/lang/", "english.json");
