...
public class GuildAudioController {
	...
	public GuildAudioController(MelodyBotInstance botInstance, Guild guild) {
		...
		/*
		 * player.setFilterFactory(((track, format, output) ->{ RotationPcmAudioFilter
		 * rotation = new RotationPcmAudioFilter(output, format.sampleRate);
		 * rotation.setRotationSpeed(0.25D); return Arrays.asList(rotation); }));
		 */
	}
